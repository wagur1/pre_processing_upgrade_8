...
def _build_models(cfg: dict, device: torch.device, role: str = "train"):
    ...
    if arch == "additive":
        ...
        raise ValueError(f"model.arch must be 'unet', 'additive', 'additive_cond', 'upvcm' or 'sandwich', got {arch!r}")
    cc = cfg["codec"]
        ...
        for qp in qp_list:
            ...
            try:
                ...
                if hasattr(pre, "post_restore"):
                    x_hat = pre.post_restore(x_hat, cond)   # POST: restore after codec
            ...
            for name in ("h264", "h265"):
                for qp in qps:
                    ...
                    if hasattr(pre, "post_restore"):
                        ...
                        xhp_post = pre.post_restore(xhp, cond)
